...
<div class="app-navbar flex-shrink-0">
    ...
    <!--end::Notifications-->
    <!--begin::Quick links (Contexto: Instituições)-->
    <div class="app-navbar-item ms-1 ms-lg-5">
        <!--begin::Menu- wrapper-->
        <div
            class="btn btn-icon btn-custom btn-active-color-primary btn-color-gray-700 w-35px h-35px w-md-40px h-md-40px"
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
            ...
            <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10"
                ...
                <h3 class="text-white fw-semibold mb-2">Instituições</h3>
                <span class="badge bg-primary text-inverse-primary py-2 px-3">3 vinculadas</span>
            </div>
            <!--end::Heading-->
            ...
            <div class="py-3">
                <!-- Item -->
                <a href="/context/switch?institution_id=1"
                    class="menu-item px-5 py-3 d-flex align-items-center justify-content-between bg-hover-light">
                    <span class="fw-semibold text-gray-800">UNIAENE</span>
                    <span class="badge badge-light-success">Atual</span>
                </a>

                <a href="/context/switch?institution_id=2"
                    class="menu-item px-5 py-3 d-flex align-items-center justify-content-between bg-hover-light">
                    <span class="fw-semibold text-gray-800">Associação Bahia Central</span>
                    <i class="ki-outline ki-arrow-right fs-5 text-primary"></i>
                </a>

                <a href="/context/switch?institution_id=3"
                    class="menu-item px-5 py-3 d-flex align-items-center justify-content-between bg-hover-light">
                    <span class="fw-semibold text-gray-800">União Leste Brasileira</span>
                    <i class="ki-outline ki-arrow-right fs-5 text-primary"></i>
                </a>
            </div>
            <!--end::List-->

            <!--begin::View more (opcional)-->
            <div class="py-2 text-center border-top">
                <a href="/minhas-instituicoes" class="btn btn-color-gray-600 btn-active-color-primary">
                    Gerenciar
                    <i class="ki-outline ki-settings fs-5"></i>
                </a>
            </div>
            <!--end::View more-->
        </div>
    ...
    */ ?>
    ...
    <div class="app-navbar-item ms-3 ms-lg-5" id="kt_header_user_menu_toggle">
        ...
        <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
            <img class="symbol symbol-circle symbol-35px symbol-md-40px" src="<?= User()->photo() ?>" alt="user" />
        </div>
